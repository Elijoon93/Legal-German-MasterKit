...
const required=[
  'assets/js/v90-shell.js','assets/css/v90-foundation.css','release-v9.0.json','release-v8.7.json','release-v8.8.json',
...
for(const token of ['Legal German MasterKit v9.0.0','v90-foundation.css?v=900','v90-shell.js?v=900','id="deviceAcceptance"','id="researchHub"'])index.includes(token)?pass('index token',token):fail('index token',token);
