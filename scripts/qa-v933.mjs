...
const VERSION='9.3.4';
const required=[
  'index.html','manifest-v934.webmanifest','service-worker-v934c.js','release-v9.3.4.json',
  'assets/js/v934-acceptance-automation.js','assets/js/v934-physical-version.js','assets/js/v934-sw-register-final2.js','assets/css/v934-acceptance.css',
...
for(const token of [
  ...
  'lgmk-v9-3-4-acceptance-automation-20260728c','v934-acceptance.css?v=934',
  'v934-acceptance-automation.js?v=934','v934-physical-version.js?v=9342',
  'v934-sw-register-final2.js?v=9342','v92-device.js?v=934'
...
index.indexOf('v934-physical-version.js?v=9342')>index.indexOf('v934-acceptance-automation.js?v=934')?pass('physical evidence guard precedence'):fail('physical evidence guard precedence');
...
const physical=fs.readFileSync('assets/js/v934-physical-version.js','utf8');
for(const token of ['physicalVersion!==VERSION','state.deviceAcceptance.manual={}','#v934Clear','LGMK_V934_PHYSICAL'])physical.includes(token)?pass('physical version token',token):fail('physical version token',token);
...
const sw=fs.readFileSync('service-worker-v934c.js','utf8');
for(const token of ['lgmk-v9-3-4-acceptance-automation-20260728c','release-v9.3.4.json','manifest-v934.webmanifest','v934-acceptance.css?v=934','v934-acceptance-automation.js?v=934','v934-physical-version.js?v=9342','v934-sw-register-final2.js?v=9342'])sw.includes(token)?pass('service worker token',token):fail('service worker token',token);
const swRegister=fs.readFileSync('assets/js/v934-sw-register-final2.js','utf8');
for(const token of ['service-worker-v934c.js?v=9342','updateViaCache:"none"','registration.waiting','LGMK_SW_V934'])swRegister.includes(token)?pass('SW registration token',token):fail('SW registration token',token);
...
console.log('\nAll cumulative v9.3.4 acceptance automation, version-locked physical evidence, safe PWA upgrade, stability, content and device gates passed.');
